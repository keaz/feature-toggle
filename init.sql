...
DELETE
FROM public.feature_evaluations;
...
VALUES ('e1111111-1111-4111-8111-111111111111', 'test-feature-create', 'env-123',
        'a1b2c3d4-0000-4000-8000-000000000001', now() - interval '1 day', true, '{
    "user": "user123"
  }', 'user123', false, now() - interval '1 day'),
       ('e2222222-2222-4222-8222-222222222222', 'test-feature-create', 'env-123',
        'a1b2c3d4-0000-4000-8000-000000000002', now(), false, '{
         "user": "user456"
       }', 'user456', true, now()),
       ('e3333333-3333-4333-8333-333333333333', 'bulk-feature-1', 'env-123', 'a1b2c3d4-0000-4000-8000-000000000001',
        now(), true, NULL, 'userA', false, now()),
